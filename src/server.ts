...
class Server {
  ...
  config() {
    const MONGO_URI =
      "mongodb+srv://agustingalante19:oRaQpFv5X7oyyee7@stockcluster.weolpnj.mongodb.net/?retryWrites=true&w=majority";

    mongoose.connect(MONGO_URI || process.env.MONGODB_URL).then(() => {
