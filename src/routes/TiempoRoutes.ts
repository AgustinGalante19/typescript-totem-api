...
class TiempoRoutes {
  ...
  async getTiempoHoy(req: Request, res: Response): Promise<void> {
    try {
      ...
      const respuesta = await axios.get(
        "https://api.openweathermap.org/data/2.5/weather?lat=-33.001146355012644&lon=-58.523484474104954&appid=bde204ad8cc3609635eb2ad3c63feac0"
      );
      const minmax = await axios.get(
        "https://api.openweathermap.org/data/2.5/onecall?lat=-33.001146355012644&lon=-58.523484474104954&exclude=hourly&appid=bde204ad8cc3609635eb2ad3c63feac0"
      );
  ...
  async getTiempoExtendido(req: Request, res: Response) {
    try {
      const respuesta = await axios.get(
        "https://api.openweathermap.org/data/2.5/forecast?id=3433658&appid=bde204ad8cc3609635eb2ad3c63feac0"
      );
